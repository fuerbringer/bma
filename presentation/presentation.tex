...
\begin{frame}
  ...
  \begin{columns}[c] % the "c" option specifies center vertical alignment
    \column{.5\textwidth} % column designated by a command
      \begin{itemize}
        \item \textbf{Handlungsplan zur Lösung eines Problems}
        \item Beispiel: Kochrezept, Lösungsverfahren für lin. oder quad. Gleichungen
        ...
        \item Name abstammend von al-Chwarizmi (geb. 780, lt. Algorismi)
        \item Sehr relevant in der Informatik
      \end{itemize}
    \column{.5\textwidth}
    \begin{figure}
  ...
  \begin{columns}
    \column{.4\textwidth}
      \begin{itemize}
        ...
        \item Kommt vor in: selbstfahrenden Fahrzeugen, Videospielen, Netzwerktechnik, ...
      \end{itemize}
    \column{.6\textwidth}
      \begin{figure}
