...
Die Implementation der Pathfinding-Algorithmen von PathFinding.js erwartet als Raum eine zweidimensionale Liste mit $4\times4$ Zellen: \\
\begin{center}
\texttt{[(0,0),(1,0),(2,0),(3,0)]}\\
\texttt{[(0,1),(1,1),(2,1),(3,1)]}\\
\texttt{[(0,2),(1,2),(2,2),(3,2)]}\\
\texttt{[(0,3),(1,3),(2,3),(3,3)]}
\end{center}
...
Daraus folgt, dass es auch keine Zwischenschritte geben kann, beispielsweise das Ziel nicht die Koordinate $(\frac{1}{2},\frac{42}{7})$ annehmen kann. 
