...
Ein Algorithmus, der für das gleiche Resultat weniger Schritte tätigen muss, ist grundsätzlich besser als ein Anderer, solange die Rechenzeit ebenfalls kleiner ausfällt. Für das wichtige Komerkmal zur Rechenzeit mussten die internen Routinen der Programmbibliothek PathFinding.js angepasst werden, da diese solche Messungsmerkmale nicht standardmässig liefert.
% TODO somehow explain this shiet
