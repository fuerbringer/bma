...
\subsection{Raster}
Pathfinder benötigen einen Raum, um ihre Arbeit zu verrichten. Die Implementation der Pathfinding-Algorithmen von PathFinding.js erwartet als Raum eine zweidimensionale Liste:\\
\begin{center}
...
Benötigt man diese Präzision, erhöht man am besten die Auflösung des Raums.
\begin{figure}[h]
  \centering
  \includegraphics[width=8cm]{grid1}
  \caption[Ein von unserer Webapplikation generiertes 8x8 Raster ohne Wände.]{Ein von unserer Webapplikation generiertes 8x8 Raster ohne Wände. Quelle: Eigenleistung}
  \label{fig:grid1}
\end{figure}
...
Der folgende prozedurale Pseudocode definiert die in unserer Webapplikation benutzte Routine\footnote{Die genaue Codestelle ist hier ersichtlich: \url{https://github.com/fuerbringer/bma/blob/master/src/maze.js\#L8}}, um Raster mit Korridoren zu versehren.
\begin{algorithmic}[1]
